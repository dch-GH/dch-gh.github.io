...
declare module '$env/static/private' {
	...
	export const EFC_9264: string;
	export const FACEPUNCH_ENGINE: string;
	export const FPS_BROWSER_APP_PROFILE_STRING: string;
	export const FPS_BROWSER_USER_PROFILE_STRING: string;
	export const GITHUB_TOKEN_EPH: string;
	export const GITHUB_TOKEN_nm: string;
	...
	export const PreferredToolArchitecture: string;
	...
	export const VALVE_NO_AUTO_P4: string;
	...
	export const XSI_PLUGINS: string;
	export const XSI_VERSION: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GITHUB_TOKEN_EPH: string;
		GITHUB_TOKEN_nm: string;
		GOPATH: string;
		HOME: string;
		HOMEDRIVE: string;
		HOMEPATH: string;
		...
		Path: string;
		PATHEXT: string;
		PreferredToolArchitecture: string;
